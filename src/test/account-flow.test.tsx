...
describe('account page after a fresh signup + login', () => {
  it('shows the signup name, then persisted phone and address', async () => {
    ...
    // The confirm → sign-in flow redirects to `next` (default discovery `/`),
    // and that sign-in awaits a full query invalidation first (auth/context.tsx).
    // Wait for the redirect to actually land before navigating on, otherwise it
    // can fire late and bounce us off /account.
